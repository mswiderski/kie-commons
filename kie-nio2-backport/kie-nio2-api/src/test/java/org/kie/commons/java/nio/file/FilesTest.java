...
public class FilesTest extends AbstractBaseTest {
    ...
    public void getFileAttributeViewGeneral() throws IOException {
        ...
        final GeneralFileAttributeView view = Files.getFileAttributeView(path, GeneralFileAttributeView.class);
    ...
    public void readAttributesGeneral() throws IOException {
        ...
        final GeneralFileAttributes attrs = Files.readAttributes(path, GeneralFileAttributes.class);
    ...
    public void readAttributesMap() throws IOException {
        ...
        assertThat(Files.readAttributes(path, "*")).isNotNull().hasSize(12);
        assertThat(Files.readAttributes(path, "basic:*")).isNotNull().hasSize(12);
