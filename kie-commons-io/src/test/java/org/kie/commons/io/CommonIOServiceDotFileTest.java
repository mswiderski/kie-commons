...
public abstract class CommonIOServiceDotFileTest {
    ...
    protected static final IOService ioService = new IOServiceDotFileImpl();
    ...
    public static class DublinCoreView extends AbstractBasicFileAttributeView<AbstractPath> {
        ...
        @Override
        public <T extends BasicFileAttributes> T readAttributes() throws org.kie.commons.java.nio.IOException {
            if ( attrs == null ) {
