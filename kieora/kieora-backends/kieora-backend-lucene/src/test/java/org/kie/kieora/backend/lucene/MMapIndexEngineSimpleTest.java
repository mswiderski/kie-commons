...
import org.kie.kieora.backend.lucene.setups.MMapLuceneSetup;
import org.kie.kieora.engine.MetaModelStore;

import static org.kie.kieora.backend.lucene.FileTestUtil.createTempDirectory;

/**
 *
 */
public class MMapIndexEngineSimpleTest extends BaseIndexEngineSimpleTest {

    private final MMapLuceneSetup luceneSetup;
    private final MetaModelStore  metaModelStore;

    public MMapIndexEngineSimpleTest() {
        try {
